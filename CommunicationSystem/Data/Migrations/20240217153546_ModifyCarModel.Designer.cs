...
namespace CommunicationSystem.Data.Migrations
{
    ...
    [Migration("20240217153546_ModifyCarModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarEngineer", b =>
                {
                    ...
                    b.Property<int>("SpecialistsEngineerID")
                        .HasColumnType("int");

                    b.HasKey("CarsCarID", "SpecialistsEngineerID");

                    b.HasIndex("SpecialistsEngineerID");

                    b.ToTable("CarEngineer");
                });

            modelBuilder.Entity("CommunicationSystem.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("CommunicationSystem.Models.Appointment", b =>
                {
            ...
            modelBuilder.Entity("CommunicationSystem.Models.Car", b =>
                {
                    b.Property<int>("CarID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommunicationSystem.Models.ServiceType", b =>
                {
                    b.Property<int>("ServiceTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EngineerServiceType", b =>
                {
                    b.Property<int>("EngineersEngineerID")
                        .HasColumnType("int");

                    b.Property<int>("SpecialityServiceTypeID")
                        .HasColumnType("int");

                    b.HasKey("EngineersEngineerID", "SpecialityServiceTypeID");

                    b.HasIndex("SpecialityServiceTypeID");

                    b.ToTable("EngineerServiceType");
                });
            ...
            modelBuilder.Entity("CarEngineer", b =>
                {
                    b.HasOne("CommunicationSystem.Models.Car", null)
                        .WithMany()
                        .HasForeignKey("CarsCarID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CommunicationSystem.Models.Engineer", null)
                        .WithMany()
                        .HasForeignKey("SpecialistsEngineerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CommunicationSystem.Models.Appointment", b =>
                {
                    b.HasOne("CommunicationSystem.Models.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CommunicationSystem.Models.Engineer", "Engineer")
                        .WithMany("Appointments")
                        .HasForeignKey("EngineerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CommunicationSystem.Models.Owner", "Owner")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("CommunicationSystem.Models.ServiceHistory", b =>
                {
                    ...
                    b.HasOne("CommunicationSystem.Models.ServiceType", "TypeOfService")
                        .WithMany()
            ...
            modelBuilder.Entity("EngineerServiceType", b =>
                {
                    ...
                    b.HasOne("CommunicationSystem.Models.ServiceType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CommunicationSystem.Models.AppUser", null)
                        .WithMany()
